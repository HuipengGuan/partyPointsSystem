...
public class ZXingCode {
    ...
    public static void main(String[] args) throws WriterException {
        File logoFile = new File("D://QrCode/logo.png");
        File QrCodeFile = new File("D://QrCode/05.png");
        String url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx3e425ee6ad27c8db&redirect_uri=http%3A%2F%2Ficefeng.imwork.net%2Fcheck&response_type=code&scope=snsapi_base&state=1#wechat_redirect";
        String note = "";
    ...
    public static void drawLogoQRCode(File logoFile, File codeFile, String qrUrl, String note) {
        try {
            ...
            if (StrKit.notBlank(note)) {
                ...
                outg.setFont(new Font("楷体", Font.BOLD, 60)); // 字体、字型、字号
